...
export default function GiftSection() {
  const [clickedImage, setClickedImage] = useState<{ src: string; alt: string; label: string } | null>(null);
  ...
  const handleImageClick = (image: { src: string; alt: string; label: string }) => {
      ...
      >
        <div className="flex flex-col justify-center items-center h-auto">
          ...
          <div className="relative w-full flex items-center justify-center overflow-hidden">
            <div className="flex transition-transform duration-500 ease-in-out w-full mx-20">
          ...
          {clickedImage && (
            ...
            >
              {/* Left side: Display the clicked image in original shape */}
  ...
  <p className="text-black text-lg text-center">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vel eros et orci euismod pharetra. Curabitur sit amet dui orci. Vivamus vitae ipsum nec est faucibus congue in eu nisl.
  </p>
             </div>
    ...
    ></div>
      ...
      <div className="w-1/2 flex items-center h-[50vh] justify-center rounded-md">
        <Image
          src="/assets/firbhet/OT85EJ1.png"
          alt="Gifting Specialist"
          className="object-cover h-[50vh] w-[105vh] rounded-md"
          width={700}
          height={100}
        />
      </div>
      ...
      <div className="w-1/2 bg-[#769ba4] flex flex-col justify-center items-center rounded-md  text-center">
